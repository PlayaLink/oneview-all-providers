...
const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  return (
    <header className="bg-white text-[#545454] px-4 py-4 border-b border-gray-300 relative z-10" role="banner" aria-label="Page header" data-testid="all-providers-header">
