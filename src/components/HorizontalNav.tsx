...
const HorizontalNav: React.FC<HorizontalNavProps> = ({
  ...
  const visibleSectionList = React.useMemo(() => {
    ...
    return gridSections.filter((section) => {
      ...
      return grids.some((grid) =>
        sectionFilters.has(grid.table_name || grid.key),
      );
    });
  ...
  return (
    <nav
      className="bg-white border-b border-[var(--stroke-light-blue-grey)]"
      role="navigation"
    ...
    >
      <div className="px-4">
        <div className="flex items-center justify-between gap-4">
          <div
            className="flex items-end pt-5 overflow-x-auto whitespace-nowrap"
            role="tablist"
                ...
                >
                  ...
                  >
                    ...
                    <svg
                      ...
                      className="svg-inline--fa fa-chevron-down w-3 h-3 ml-1"
                      role="img"
