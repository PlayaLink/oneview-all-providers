  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          className="text-white text-center text-xs leading-normal tracking-wide hover:text-gray-300 bg-transparent border-none cursor-pointer px-2 py-1 rounded transition-colors font-bold"
