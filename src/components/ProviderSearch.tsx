  ...
  return (
    <div className={`relative ${className}`} data-testid="provider-search">
      ...
      <input
        id="provider-search"
        ref={inputRef}
        className="w-full rounded border border-gray-200 px-4 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-blue-200 pr-8"
      ...
      <Icon
        icon="search"
        className="absolute right-3 top-1/2 -translate-y-1/2 w-3 h-3 text-gray-800"
        aria-hidden="true"
      />
      {/* Dropdown */}
