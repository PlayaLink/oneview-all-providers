...
if (template?.DetailsComponent) {
  ...
  const containerClassName = context === 'sidepanel'
  ...
  const containerStyle = context === 'sidepanel' ? {
    width: `${panelWidth}px`,
    boxShadow: isOpen
  ...
  const footerClassName = context === 'sidepanel'
  ...
  const footerStyle = context === 'sidepanel' ? {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <div className={headerClassName} data-testid={`grid-item-details-header-${context}`}>
