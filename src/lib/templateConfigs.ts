    ...
    fieldGroups: [
      {
        ...
        fields: [
          ...
          { label: "Country of Citizenship", fieldType: "single-select", dataType: "text", options: ["United States", "Canada", "Mexico", "Brazil", "United Kingdom", "France", "Germany", "Italy", "Spain", "Russia", "China", "Japan", "South Korea", "India", "Australia", "New Zealand", "South Africa", "Egypt", "Nigeria", "Kenya", "Turkey", "Saudi Arabia", "Israel", "United Arab Emirates", "Argentina", "Chile", "Colombia", "Peru", "Venezuela", "Sweden", "Norway", "Denmark", "Finland", "Poland", "Netherlands", "Belgium", "Switzerland", "Austria", "Greece", "Portugal", "Ireland", "Czech Republic", "Hungary", "Romania", "Bulgaria", "Thailand", "Vietnam", "Philippines", "Indonesia", "Pakistan", "Bangladesh"], rowKey: "country_of_citizenship", group: "Birth Info" },
          { label: "Citizenship/Work Auth", fieldType: "single-select", dataType: "text", options: ["Permanent Resident", "Visa", "U.S. Citizen (Birth/Naturalization)", "Work Authorization Card"], rowKey: "citizenship_work_auth", group: "Birth Info" },
          { label: "US Work Auth", fieldType: "single-select", dataType: "text", options: ["Yes", "No"], rowKey: "us_work_auth", group: "Birth Info" },
          { label: "Birth City", fieldType: "text", dataType: "text", rowKey: "birth_city", group: "Birth Info" },
          { label: "Birth State/Province", fieldType: "single-select", dataType: "text", options: ["AL", "AK", "AZ", "AR", "CA", "CO", "CT", "DE", "FL", "GA", "HI", "ID", "IL", "IN", "IA", "KS", "KY", "LA", "ME", "MD", "MA", "MI", "MN", "MS", "MO", "MT", "NE", "NV", "NH", "NJ", "NM", "NY", "NC", "ND", "OH", "OK", "OR", "PA", "RI", "SC", "SD", "TN", "TX", "UT", "VT", "VA", "WA", "WV", "WI", "WY"], rowKey: "birth_state_province", group: "Birth Info" },
          { label: "Birth County", fieldType: "text", dataType: "text", rowKey: "birth_county", group: "Birth Info" },
          { label: "Birth Country", fieldType: "single-select", dataType: "text", options: ["United States", "Canada", "Mexico", "Brazil", "United Kingdom", "France", "Germany", "Italy", "Spain", "Russia", "China", "Japan", "South Korea", "India", "Australia", "New Zealand", "South Africa", "Egypt", "Nigeria", "Kenya", "Turkey", "Saudi Arabia", "Israel", "United Arab Emirates", "Argentina", "Chile", "Colombia", "Peru", "Venezuela", "Sweden", "Norway", "Denmark", "Finland", "Poland", "Netherlands", "Belgium", "Switzerland", "Austria", "Greece", "Portugal", "Ireland", "Czech Republic", "Hungary", "Romania", "Bulgaria", "Thailand", "Vietnam", "Philippines", "Indonesia", "Pakistan", "Bangladesh"], rowKey: "birth_country", group: "Birth Info" },
          { label: "Gender", fieldType: "single-select", dataType: "text", options: ["Female", "Male", "Non-Binary"], rowKey: "gender", group: "Birth Info" },
          ...
          { label: "Hair Color", fieldType: "single-select", dataType: "text", options: ["Black", "Brown", "Blonde", "White", "Red", "Gray", "Bald"], rowKey: "hair_color", group: "Birth Info" },
          { label: "Eye Color", fieldType: "single-select", dataType: "text", options: ["Amber", "Blue", "Brown", "Green", "Red", "Hazel", "Violet"], rowKey: "eye_color", group: "Birth Info" },
          ...
          { label: "Ethnicity", fieldType: "single-select", dataType: "text", options: ["American Indian or Alaska Native", "Asian", "Black or African American", "Choose not to answer", "Hispanic or Latino/a", "Middle Eastern and North African", "Native Hawaiian or Other Pacific Islander"], rowKey: "ethnicity", group: "Birth Info" },
