-- =====================================================
-- COMPREHENSIVE DATABASE RESTRUCTURE MIGRATION (FIXED V2)
...
-- Step 5: Create optimized views for different use cases (FIXED)
-- =====================================================
...
-- Facility with properties (simplified to avoid nested aggregations)
...
SELECT 
  ...
  COALESCE(
    ...
    WHERE fp."group" IS NOT NULL
    LIMIT 1),
    '{}'::json
  ) as properties_by_group
FROM facilities f;

-- Facility with requirements (simplified to avoid nested aggregations)
...
-- Comprehensive facility view with all data (simplified)
