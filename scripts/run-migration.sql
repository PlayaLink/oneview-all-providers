-- Run this script in your Supabase SQL Editor to create the feature_settings table
...
CREATE POLICY "Allow authenticated users to insert feature settings" ON feature_settings
