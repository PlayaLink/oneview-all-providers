-- Clean and re-seed grid_actions table
...
SELECT get_grid_id('provider_info'), get_action_id('activate'), 1
WHERE get_grid_id('provider_info') IS NOT NULL AND get_action_id('activate') IS NOT NULL;

INSERT INTO public.grid_actions (grid_id, action_id, "order")
SELECT get_grid_id('provider_info'), get_action_id('verifications'), 2
WHERE get_grid_id('provider_info') IS NOT NULL AND get_action_id('verifications') IS NOT NULL;
...
INSERT INTO public.grid_actions (grid_id, action_id, "order")
SELECT get_grid_id('birth_info'), get_action_id('activate'), 1
WHERE get_grid_id('birth_info') IS NOT NULL AND get_action_id('activate') IS NOT NULL;
...
INSERT INTO public.grid_actions (grid_id, action_id, "order")
SELECT get_grid_id('state_licenses'), get_action_id('activate'), 1
WHERE get_grid_id('state_licenses') IS NOT NULL AND get_action_id('activate') IS NOT NULL;
...
INSERT INTO public.grid_actions (grid_id, action_id, "order")
SELECT get_grid_id('facility_affiliations'), get_action_id('activate'), 1
WHERE get_grid_id('facility_affiliations') IS NOT NULL AND get_action_id('activate') IS NOT NULL;
